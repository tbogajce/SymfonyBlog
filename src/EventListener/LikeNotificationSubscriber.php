...
class LikeNotificationSubscriber implements EventSubscriber
{
    ...
    // has to be named like the event we are listening
    public function onFlush(OnFlushEventArgs $args) {
        $em = $args->getEntityManager();
        // unit of works tracks changes made to all the entities
        $uow = $em->getUnitOfWork();

        // getScheduledCollectionUpdates is a list of all the persistent collection objects
        /**
